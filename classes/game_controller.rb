...
class GameController
  ...
  def add_game
    ...
    puts "You can use one of the above author's option eg: 0 Or press Enter to ignore and create the new game's author" unless @author_db.empty?
    option = gets.chomp
    if option.eql?('')
    ...
    game_multiplayer = is_multiplayer_game.eql?('yes')
