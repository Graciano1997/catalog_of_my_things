...
class MusicAlbumController
  ...
  def add_music
    ...
    music_publish_date = Date.parse(gets.chomp.to_s)
    puts 'Is the music released on spotify ? Type Yes or No'
    is_music_on_spotify = gets.chomp.to_s.downcase
    music_on_spotify = is_music_on_spotify.eql?('yes')
    music_element = MusicAlbum.new(music_publish_date, music_on_spotify)
